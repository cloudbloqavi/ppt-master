...
THANKS_KEYWORDS = ("thank", "thanks", "q&a", "qa", "contact", "acknowledgements", "questions", "contact_info")
TOC_KEYWORDS = ("agenda", "contents", "content", "outline", "table_of_contents", "agenda_page", "contents_page")
CHAPTER_KEYWORDS = ("chapter", "part", "section", "chapter_title", "segment")
