#!/usr/bin/env python3
"""
Presentation Builder - Examples Index Generator
...
def generate_examples_index(examples_dir: str = 'examples') -> str:
    ...
    content = []
    content.append("# Presentation Builder Example Projects Index\n")
    ...
    content.append("---\n")
    content.append(
        f"*Auto-generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} by Presentation Builder*")
...
def main() -> None:
    ...
    print("=" * 80)
    print("Presentation Builder - Examples Index Generator")
    print("=" * 80 + "\n")
