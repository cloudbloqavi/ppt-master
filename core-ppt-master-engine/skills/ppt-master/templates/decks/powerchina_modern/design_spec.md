...
# POWERCHINA Modern Template v2 - Design Specification

> Suitable for POWERCHINA major project reports, international market promotion, technology achievement showcases, high-end business negotiations, and similar scenarios.
...
| -------------- | ---------------------------------------------------------------- |
| **Template Name** | powerchina_modern (formerly powerchina_v2)                        |
