...
# POWERCHINA (POWERCHINA) Standard Template - Design Specification
...
| -------------- | ---------------------------------------------------------------- |
| **Template Name** | powerchina_standard (formerly powerchina)                           |
...
**Font Stack**: `"Microsoft YaHei", "Microsoft YaHei", "SimHei", Arial, sans-serif`
