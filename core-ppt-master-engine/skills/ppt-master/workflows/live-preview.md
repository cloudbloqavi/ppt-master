...
>
> **Not in scope**: Executor's conditional startup (disabled by default) — that lives in [`SKILL.md`](../SKILL.md) Step 6. Do not re-launch a preview that is already running.
