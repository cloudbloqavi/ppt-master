...
5. Run the matching calculator command:
   ...
   python3 core-ppt-master-engine/skills/ppt-master/scripts/svg_position_calculator.py calc bar \
   ...
   python3 core-ppt-master-engine/skills/ppt-master/scripts/svg_position_calculator.py calc line \
   ...
   python3 core-ppt-master-engine/skills/ppt-master/scripts/svg_position_calculator.py calc pie \
   ...
   python3 core-ppt-master-engine/skills/ppt-master/scripts/svg_position_calculator.py calc radar \
...
```bash
python3 core-ppt-master-engine/skills/ppt-master/scripts/svg_quality_checker.py <project_path>
```
